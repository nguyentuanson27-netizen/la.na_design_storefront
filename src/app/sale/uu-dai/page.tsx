...
/** Markup only: `@/routes/sale` narrows the sale read to PROMOTION campaigns. */
...
function render(data: FlashSaleViewModel) {
  return (
    <ListingShell>
      ...
      <SaleListingBody
        data={data}
        countLabel="sản phẩm đang ưu đãi"
        emptyTitle="Hiện chưa có sản phẩm trong chương trình ưu đãi."
        paginationLabel="Phân trang Ưu đãi"
      />
    </ListingShell>
  );
}
