# Storefront PDP / PLP Refinement — Todo

- [x] Owner approved `docs/specs/storefront-pdp-plp-refinement.md`.
- [x] T1 Update active docs and add RED contract/browser tests.
- [x] T1 Observe expected failing verification on old implementation.
- [x] T2 Implement desktop gallery grouping/navigation + two-column info row.
- [x] T2 Keep slide 1 canonical on initial load (including `?variant=`), preserve post-load variant/media seam, and gate desktop rules to `lg` without pinning mobile structure.
- [x] T3 Implement unresolved-kind guidance, copy cleanup and brown/cream purchase styling.
