...
- [ ] Human approves G4 merchandising **migration path**; no merchandising schema migration before this checkpoint. ADR 0013 specifies exactly six additive models: `HomepageFeaturedProduct`, `ProductCategoryTree`, `ProductCategoryMembership`, `CategoryProductOrder`, `CategoryEditorialMedia`, `RelatedProductOverride`. No backfill is permitted; category membership starts empty and is admin-assigned.
